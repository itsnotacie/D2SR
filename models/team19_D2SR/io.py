...
from models.team19_D2SR.model import D2SR
...
def main(model_dir, input_path, output_path, device=None):
    ...
    parser.add_argument('--pretrained_path', type=str, default='model_zoo/team19_D2SR/D2SR.pkl', help="path to a model state dict to be used")
